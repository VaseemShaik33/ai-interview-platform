...
public class InterviewSessionController {
    ...
    public com.aiinterview.platform.dto.InterviewResultDetailResponse getDetailedResult(
            @PathVariable Long sessionId, Authentication authentication) {
        return interviewSessionService.getDetailedResult(sessionId, (User) authentication.getPrincipal());
    }
